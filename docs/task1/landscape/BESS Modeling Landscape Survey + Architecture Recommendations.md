...
- **LAM\_NE** — Loss of active material in the negative electrode  
- **LAM\_PE** — Loss of active material in the positive electrode  
...
- **POC** — Point of Interconnection  
- **PyBaMM** — Python Battery Mathematical Modelling  
- **Q\_neg / Q\_pos / Q\_Li** — State variables in the NREL semi-empirical model representing negative-electrode capacity, positive-electrode capacity, and lithium inventory related capacity  
- **R** — Resistance  
...
- **SOC** — State of charge  
- **SOH** — State of health  
- **SOH\_C** — Capacity-based state of health  
...
- Brief intro to degradation modes — LLI and LAM (LAM\_NE, LAM\_PE); observable consequences: capacity fade and resistance growth (more detail in Section 3\)  
...
- Smith, K., Shi, Y., Santhanagopalan, S. *Degradation Mechanisms and Lifetime Prediction for Lithium-Ion Batteries — A Control Perspective.* NREL/CP-5400-64171, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64171.pdf)) — mechanism taxonomy, SEI growth dominance argument, √t trajectory  
- Zitara. *Understanding Lithium-Ion Battery Degradation.* ([Link](https://www.zitara.com/resources/lithium-ion-battery-degradation)) — accessible primer on degradation causes and effects  
- Dubarry, M., et al. *Accurate LLI and LAM\_PE Estimation Using the Mechanistic Modeling Approach with Layered Oxides.* J. Electrochem. Soc., 170, 070503, 2023\. ([DOI](https://doi.org/10.1149/1945-7111/ace21c)) — three-mode (LLI/LAM) framework introduction
...
- DiOrio, N., et al. *Technoeconomic Modeling of Battery Energy Storage in SAM.* NREL/TP-6A20-64641, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64641.pdf)) — SAM's cells-in-series/parallel bank model and AC-coupled architecture
...
- Note: SAM models AC-coupled topology with two single-point efficiencies (η\_ACDC, η\_DCAC); DUET should follow same pattern

**References:**

- DiOrio, N., et al. *Technoeconomic Modeling of Battery Energy Storage in SAM.* NREL/TP-6A20-64641, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64641.pdf)) — voltage model, PCS efficiency model
...
- Modeling implications by chemistry:  
  ...
  - NMC/NCA: more sloped OCV (easier SOC estimation); LAM\_PE from layered oxide degradation is a real concern; higher temperature sensitivity  
...
- ACCURE Battery Intelligence. *SOC Estimation for LFP Batteries.* Whitepaper, 2024\. — LFP flat OCV, hysteresis, SOC estimation challenge ([Direct Link](https://8523892.fs1.hubspotusercontent-eu1.net/hubfs/8523892/assets/ACCURE_Whitepaper_State_of_Charge.pdf))  
- Smith, K., et al. *Life Prediction Model for Grid-Connected Li-ion Battery Energy Storage System.* NREL/CP-5400-67102, 2017\. ([PDF](https://www.nrel.gov/docs/fy17osti/67102.pdf)) — NMC/graphite parameterized model; notes on chemistry-specificity  
- Gwayi, I., et al. *A Review of Lithium-Ion Battery Empirical and Semi-Empirical Aging Models for Off-Grid RES.* Engineering Reports, 2025; 7:e70169. ([DOI](https://doi.org/10.1002/eng2.70169)) — 19 calendar \+ 20 cycle aging studies; LFP vs. NMC coverage
...
- The three root degradation modes (introduce the LLI/LAM framework without going into model equations — Section 3 covers that):  
  ...
  - LAM\_NE (Loss of Active Material, Negative): graphite anode structural damage from mechanical stress; self-reinforcing at low temperatures and high DoD  
  - LAM\_PE (Loss of Active Material, Positive): cathode structural degradation; particularly relevant for NMC/NCA layered oxides  
...
- Smith, K., et al. *Degradation Mechanisms and Lifetime Prediction for Lithium-Ion Batteries.* NREL/CP-5400-64171, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64171.pdf)) — mechanism taxonomy, SEI dominance, √t trajectory, coupling hypotheses  
- Smith, K., et al. *Life Prediction Model for Grid-Connected Li-ion BESS.* NREL/CP-5400-67102, 2017\. ([PDF](https://www.nrel.gov/docs/fy17osti/67102.pdf)) — oversizing vs. thermal management tradeoff  
- Zitara. *Understanding Lithium-Ion Battery Degradation.* ([Link](https://www.zitara.com/resources/lithium-ion-battery-degradation)) — six causes of degradation (accessible framing)
...
- DiOrio, N., et al. *Technoeconomic Modeling of Battery Energy Storage in SAM.* NREL/TP-6A20-64641, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64641.pdf)) — lumped thermal model equations, trapezoidal solver  
- Smith, K., et al. *Life Prediction Model for Grid-Connected Li-ion BESS.* NREL/CP-5400-67102, 2017\. ([PDF](https://www.nrel.gov/docs/fy17osti/67102.pdf)) — temperature effects on degradation
...
- Smith, K., et al. *Degradation Mechanisms and Lifetime Prediction for Lithium-Ion Batteries.* NREL/CP-5400-64171, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64171.pdf)) — mechanism taxonomy, coupling hypotheses  
- Gwayi, I., et al. *A Review of Li-Ion Battery Empirical and Semi-Empirical Aging Models.* Engineering Reports, 2025; 7:e70169. ([DOI](https://doi.org/10.1002/eng2.70169)) — 13-model catalog, 46% resistance gap finding  
- Dubarry, M., et al. *Accurate LLI and LAM\_PE Estimation.* J. Electrochem. Soc., 170, 070503, 2023\. ([DOI](https://doi.org/10.1149/1945-7111/ace21c)) — 4-tier taxonomy
...
- ACCURE Battery Intelligence. *SOC Estimation for LFP Batteries.* Whitepaper, 2024\. — complete treatment of LFP SOC problem, BMS tiers, cloud analytics ([Direct Link](https://8523892.fs1.hubspotusercontent-eu1.net/hubfs/8523892/assets/ACCURE_Whitepaper_State_of_Charge.pdf))

### 2.5 State of Health (SOH) Tracking and Lifetime Prediction

- SOH definitions: SOH\_C (capacity relative to BoL: `C_current / C_BoL`) and SOH\_R (resistance relative to BoL: `R_current / R_BoL`) — why a single SOH number is insufficient; the two metrics tell different stories  
...
- DiOrio, N., et al. *Technoeconomic Modeling of Battery Energy Storage in SAM.* NREL/TP-6A20-64641, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64641.pdf)) — rainflow counting methodology, SAM lookup table lifetime model, EOL threshold  
- Smith, K., et al. *Life Prediction Model for Grid-Connected Li-ion BESS.* NREL/CP-5400-67102, 2017\. ([PDF](https://www.nrel.gov/docs/fy17osti/67102.pdf)) — state-variable model for EOL projection; 70% capacity threshold
...
- DiOrio, N., et al. *Technoeconomic Modeling of Battery Energy Storage in SAM.* NREL/TP-6A20-64641, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64641.pdf)) — dispatch algorithm logic, constraint controller stack
...
- DiOrio, N., et al. *Technoeconomic Modeling of Battery Energy Storage in SAM.* NREL/TP-6A20-64641, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64641.pdf)) — cells-in-series/parallel bank model
...
- ACCURE Battery Intelligence. *SOC Estimation for LFP Batteries.* Whitepaper, 2024\. — BMS SOC vs. corrected SOC as the comparison layer ([Direct Link](https://8523892.fs1.hubspotusercontent-eu1.net/hubfs/8523892/assets/ACCURE_Whitepaper_State_of_Charge.pdf))
...
| Semi-empirical (state-variable) | NREL Smith 2017 | Q\_Li, Q\_neg, Q\_pos, R (8 states) | Aging test data \+ Arrhenius (20+ parameters) | Aggregate mechanisms (LLI-equivalent, LAM-equivalent) |
| Mechanistic | ACCURE / Dubarry 2023 | LLI, LAM\_NE, LAM\_PE from voltage curves | Half-cell OCV data \+ full-cell cycling | Electrode-level — *which* mode dominates |
...
- Dubarry, M., et al. *Accurate LLI and LAM\_PE Estimation.* J. Electrochem. Soc., 2023\. ([DOI](https://doi.org/10.1149/1945-7111/ace21c)) — 4-tier table  
- ACCURE Battery Intelligence. *Mechanistic Modeling Battery Aging.* Blog post. ([Link](https://accure.net/blogs/mechanistic-modeling-battery-aging))  
- Wang, A.A., et al. *Review of parameterisation and LiionDB.* Progress in Energy, 2022\. ([DOI](https://doi.org/10.1088/2516-1083/ac692c)) — full spectrum summary
...
- Gwayi, I., et al. *A Review of Li-Ion Battery Empirical and Semi-Empirical Aging Models.* Engineering Reports, 2025; 7:e70169. ([DOI](https://doi.org/10.1002/eng2.70169)) — all 13 models, statistics, key equations

#### 3.2.1 The NREL Semi-Empirical Model (Smith et al. 2017\)

- Context: a later NREL state-variable degradation model and the reference implementation for DUET Task 2B. It is conceptually aligned with the NREL/SAM lineage, but distinct from BattWatts' original 2015 lookup-table lifetime model described in Section 3.6  
...
- Capacity model: three competing mechanisms, `Q = min(Q_Li, Q_neg, Q_pos)`:  
  - Q\_Li: lithium loss from calendar SEI (√t), cycling-driven SEI cracking (×N), break-in (saturating exponential)  
  - Q\_neg: graphite site loss from mechanical fatigue (self-reinforcing ODE)  
  - Q\_pos: initial positive electrode wetting (minor; saturating at BoL)  
...
- Limitations: NMC/graphite only (no LFP parameters); no explicit C-rate term; no LAM\_PE for layered oxides; 11-cell dataset; 0°C and 55°C show largest residuals

**References:**

- Smith, K., et al. *Life Prediction Model for Grid-Connected Li-ion BESS.* NREL/CP-5400-67102, 2017\. ([PDF](https://www.nrel.gov/docs/fy17osti/67102.pdf)) — full parameter catalog, model equations, validation results  
- Smith, K., et al. *Degradation Mechanisms and Lifetime Prediction.* NREL/CP-5400-64171, 2015\. ([PDF](https://www.nrel.gov/docs/fy15osti/64171.pdf)) — theoretical foundation; competing-mechanism coupling choice
...
- Core principle: full-cell voltage \= `V_PE(Q) − V_NE(Q)`; by adjusting how electrode curves are aligned/scaled, the model emulates LLI/LAM\_NE/LAM\_PE effects on the observable voltage profile  
...
- The inaccessible lithium correction (Dubarry 2023): layered oxide cathodes (NMC, NCA, LCO) are never fully delithiated at normal cutoffs; models that ignore this systematically overestimate LLI and underestimate LAM\_PE; the correction equations  
...
- Mapping to NREL model: LLI \<-\> Q\_Li, LAM\_NE \<-\> Q\_neg, LAM\_PE not in NREL

**References:**

- Dubarry, M., et al. *Accurate LLI and LAM\_PE Estimation.* J. Electrochem. Soc., 170, 070503, 2023\. ([DOI](https://doi.org/10.1149/1945-7111/ace21c)) — model framework, inaccessible lithium problem, correction equations, mapping to NREL states  
- ACCURE Battery Intelligence. *Mechanistic Modeling Battery Aging.* Blog post. ([Link](https://accure.net/blogs/mechanistic-modeling-battery-aging))
...
- Wang, A.A., et al. *Review of parameterisation and LiionDB.* Progress in Energy, vol. 4, 032004, 2022\. ([DOI](https://doi.org/10.1088/2516-1083/ac692c))  
- PyBaMM: ([GitHub](https://github.com/pybamm-team/PyBaMM))  
- Dubarry, M., et al. *Accurate LLI and LAM\_PE Estimation.* J. Electrochem. Soc., 2023\. ([DOI](https://doi.org/10.1149/1945-7111/ace21c)) — positioning PyBaMM in tier 4
...
- Data requirements: V (0.5V, 2s), I (0.5A, 2s), T (1°C, 60s), SOC (1%, 30s), cell V\_min/V\_max (0.01V, 2s) \+ system metadata  
...
- ACCURE Battery Intelligence. *SOC Estimation for LFP Batteries.* Whitepaper, 2024 ([Direct Link](https://8523892.fs1.hubspotusercontent-eu1.net/hubfs/8523892/assets/ACCURE_Whitepaper_State_of_Charge.pdf))  
- Dubarry, M., et al. *Accurate LLI and LAM\_PE Estimation.* J. Electrochem. Soc.. ([DOI](https://doi.org/10.1149/1945-7111/ace21c))  
- Zitara. *Understanding Lithium-Ion Battery Degradation.* ([Link](https://www.zitara.com/resources/lithium-ion-battery-degradation))
...
- Wang, A.A., et al. *Review of parameterisation and LiionDB.* Progress in Energy, 2022\. ([DOI](https://doi.org/10.1088/2516-1083/ac692c))  
- Gwayi, I., et al. *A Review of Li-Ion Battery Aging Models.* Engineering Reports, 2025\. ([DOI](https://doi.org/10.1002/eng2.70169))
...
- ACCURE Battery Intelligence. *SOC Estimation for LFP Batteries.* Whitepaper, 2024\. ([Direct Link](https://8523892.fs1.hubspotusercontent-eu1.net/hubfs/8523892/assets/ACCURE_Whitepaper_State_of_Charge.pdf))  
- Gwayi, I., et al. *A Review of Li-Ion Battery Aging Models.* Engineering Reports, 2025\. ([DOI](https://doi.org/10.1002/eng2.70169)) — LFP parameterizations; CCYACM3 recommendation
...
- ACCURE Battery Intelligence. *SOC Estimation for LFP Batteries.* Whitepaper, 2024\. — SOC comparison layer design; chemistry-specific confidence levels ([Direct Link](https://8523892.fs1.hubspotusercontent-eu1.net/hubfs/8523892/assets/ACCURE_Whitepaper_State_of_Charge.pdf))